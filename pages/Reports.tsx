                         ...
                         {reportData.specialPoints.map(sp => (
                             <tr key={sp.id} className="border-b border-gray-100 last:border-0">
                                 ...
                                 <td className="px-4 py-2">
                                     <span className={`text-xs font-bold px-2 py-0.5 rounded ${sp.house === House.ANKARA ? 'bg-red-100 text-red-700' : sp.house === House.BAGDAD ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}`}>
                                         {sp.house}
                                     </span>
                                 </td>
